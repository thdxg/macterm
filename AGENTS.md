...
- **Remote projects require zmx preinstalled on the host** (in non-interactive-shell `PATH`) — a missing binary surfaces as `command not found` in the pane. No upload/install flow yet.
