...
- `Macterm/Config/` — `MactermConfig` (+ `Experiments`), `GhosttyConfigSource`, `GhosttyConfigText`, `ShellIntegrationFeatures`, `GhosttyColorSpace`, `MacosHidden`.
