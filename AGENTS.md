...
A pane for features that work but haven't earned a permanent home: every toggle defaults **off**, does nothing to a user who never opens the pane, and is expected to graduate or be removed. Three live there today, two of them pure ghostty shaders and one a fork patch.
